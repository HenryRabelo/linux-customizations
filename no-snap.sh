...
echo 'Package: snapd' >> '/etc/apt/preferences.d/no-snap.pref'
echo 'Pin: release a=*' >> '/etc/apt/preferences.d/no-snap.pref'
echo 'Pin-Priority: -10' >> '/etc/apt/preferences.d/no-snap.pref'
